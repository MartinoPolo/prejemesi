...
**Admin** — App operator matched via `ADMIN_EMAILS` env var; the only role that can revert a reserved shared list to draft. Not a správce, never surfaces in list UI.
