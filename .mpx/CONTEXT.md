...
**Crop rect** — A normalized 0–1 editing rectangle persisted alongside focal point so the crop editor can restore the exact region the user drew. Since issue #116 it is always locked to its target's aspect ratio, making the focal+zoom render a lossless reproduction. Not used for rendering — focal point is.
