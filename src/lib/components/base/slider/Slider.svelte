...
<input
	...
	class={cn(
		...
		'[&::-webkit-slider-thumb]:size-4 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-ink [&::-webkit-slider-thumb]:bg-card [&::-webkit-slider-thumb]:shadow-[var(--elevation-compact)]',
