 ...
 */
export const overlayCloseButtonClass = `absolute top-4 right-4 size-(--size-control-lg) rounded-full border-[2.5px] border-ink bg-card text-ink hover:bg-card hover:text-ink [&_svg]:size-4 [&_svg]:transition-transform [&_svg]:duration-200 [&_svg]:ease-spring hover:[&_svg]:rotate-90 motion-reduce:[&_svg]:transition-none motion-reduce:hover:[&_svg]:rotate-0 ${CIRCULAR_STICKER_BUTTON_CLASSES}`;
