...
export const emptyStateVariants = tv({
	slots: {
		root: 'flex flex-col items-center gap-2.5 rounded-panel border-[3px] border-dashed border-ink-soft px-6 py-12 text-center',
		...
		description: 'max-w-[44ch] text-[15px] leading-relaxed text-ink-soft',
	},
});
