<script lang="ts">
	...
	// Likes load only in the browser; the count updates when the client-side query lands.
...
<div class="flex min-w-0 flex-col gap-8" data-palette={demoPalette}>
	...
	<div class="lg:hidden">
		...
		<p class="mt-3 text-center text-(length:--text-base) leading-relaxed text-muted-foreground">
	...
	<div class="flex flex-col items-center gap-2 lg:hidden">
		...
		>
			<ToggleGroup.Item value={DEMO_VIEWPOINTS.gifter} data-testid="landing-demo-role-gifter">
